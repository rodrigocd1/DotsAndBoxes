(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(e,t){return{row:e,col:t}}function t(e,t){let n=e.row===t.row&&Math.abs(e.col-t.col)===1,r=e.col===t.col&&Math.abs(e.row-t.row)===1;return n||r}function n(n,r,i=null){if(!t(n,r))throw RangeError(`Pontos não adjacentes: (${n.row},${n.col}) e (${r.row},${r.col})`);let a=n.row<r.row||n.row===r.row&&n.col<r.col,o=a?n:r,s=a?r:n;return{from:e(o.row,o.col),to:e(s.row,s.col),ownerId:i}}function r(e){return`${e.from.row===e.to.row?`h`:`v`}-${e.from.row}-${e.from.col}`}function i(e){return`b-${e.row}-${e.col}`}function a(t){let i=t.row,a=t.col;return[r(n(e(i,a),e(i,a+1))),r(n(e(i+1,a),e(i+1,a+1))),r(n(e(i,a),e(i+1,a))),r(n(e(i,a+1),e(i+1,a+1)))]}function o(t,a){if(t<2)throw RangeError(`gridSize deve ser >= 2`);if(a.length<2)throw RangeError(`É necessário ao menos 2 jogadores`);let o={};for(let i=0;i<t;i++)for(let a=0;a<t-1;a++){let t=n(e(i,a),e(i,a+1));o[r(t)]=t}for(let i=0;i<t-1;i++)for(let a=0;a<t;a++){let t=n(e(i,a),e(i+1,a));o[r(t)]=t}let s={};for(let n=0;n<t-1;n++)for(let r=0;r<t-1;r++){let t={topLeft:e(n,r),ownerId:null};s[i(t.topLeft)]=t}let c=a[0];return{gridSize:t,players:a.map(e=>({...e,score:0})),lines:o,boxes:s,currentPlayerId:c.id,status:`playing`}}function s(e,t,n){return{id:e,name:t,color:n,score:0}}function c(e){return{ok:!0,value:e}}function l(e,t=null){return{ok:!1,error:e,code:t}}var u={GAME_FINISHED:`GAME_FINISHED`,LINE_NOT_FOUND:`LINE_NOT_FOUND`,LINE_ALREADY_TAKEN:`LINE_ALREADY_TAKEN`};function d(e,t){if(e.status===`finished`)return l(`A partida já terminou`,u.GAME_FINISHED);let n=r(t),o=e.lines[n];if(o===void 0)return l(`Linha inexistente no tabuleiro`,u.LINE_NOT_FOUND);if(o.ownerId!==null)return l(`Linha já foi jogada`,u.LINE_ALREADY_TAKEN);let s=e.currentPlayerId,d={...e.lines,[n]:{...o,ownerId:s}},f={...e.boxes},p=0;for(let t of Object.values(e.boxes))t.ownerId===null&&a(t.topLeft).every(e=>{let t=d[e];return t!==void 0&&t.ownerId!==null})&&(f[i(t.topLeft)]={...t,ownerId:s},p+=1);let m=e.players.map(e=>e.id===s?{...e,score:e.score+p}:{...e}),h=Object.values(d).every(e=>e.ownerId!==null)?`finished`:`playing`,te=h===`finished`||p>0?s:ee(e.players,s);return c({...e,lines:d,boxes:f,players:m,currentPlayerId:te,status:h})}function ee(e,t){return e[(e.findIndex(e=>e.id===t)+1)%e.length].id}function f(e){return Object.values(e.lines).filter(e=>e.ownerId===null)}var p=class{state;constructor(e){this.state=this.buildState(e)}buildState(e){let t=e.players.map((e,t)=>s(`p${t+1}`,e.name,e.color));return o(e.gridSize,t)}getState(){return this.state}playLine(e){let t=d(this.state,e);return t.ok?(this.state=t.value,!0):!1}reset(e){this.state=this.buildState(e)}getAvailableLines(){return f(this.state)}},m=80,h=50,te=7,ne=24;function g(e){return h+e*m}function _(e){return h+e*m}function re(e,t){return t?e.players.find(e=>e.id===t)?.color??`#888`:`#ccc`}function ie(e){let t=h*2+(e-1)*m;return{width:t,height:t}}function ae(e,t,n,i=!1){let{gridSize:a}=t,{width:o,height:s}=ie(a);e.clearRect(0,0,o,s),e.fillStyle=`#ffffff`,e.fillRect(0,0,o,s);for(let n of Object.values(t.boxes)){if(!n.ownerId)continue;let r=re(t,n.ownerId),i=g(n.topLeft.col),a=_(n.topLeft.row);e.fillStyle=r+`33`,e.fillRect(i+1,a+1,m-2,m-2);let o=t.players.find(e=>e.id===n.ownerId);o&&(e.fillStyle=r+`bb`,e.font=`bold ${Math.floor(m*.35)}px system-ui, sans-serif`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(o.name[0]?.toUpperCase()??`?`,i+m/2,a+m/2))}let c=t.players.find(e=>e.id===t.currentPlayerId);for(let i of Object.values(t.lines)){let a=n!==null&&r(n)===r(i);e.beginPath(),e.moveTo(g(i.from.col),_(i.from.row)),e.lineTo(g(i.to.col),_(i.to.row)),e.lineCap=`round`,i.ownerId===null?a?(e.strokeStyle=(c?.color??`#888`)+`cc`,e.lineWidth=6):(e.strokeStyle=`#dde1e7`,e.lineWidth=3):(e.strokeStyle=re(t,i.ownerId),e.lineWidth=7),e.stroke()}for(let t=0;t<a;t++)for(let n=0;n<a;n++)e.beginPath(),e.arc(g(n),_(t),te,0,Math.PI*2),e.fillStyle=`#2c3e50`,e.fill()}function oe(t,i,a){let{gridSize:o}=t,s=null,c=ne;for(let l=0;l<o;l++)for(let u=0;u<o-1;u++){let o=g(u),d=g(u+1),ee=_(l);if(i>=o-4&&i<=d+4){let i=Math.abs(a-ee);if(i<c){c=i;let a=r(n(e(l,u),e(l,u+1)));s=t.lines[a]??null}}}for(let l=0;l<o-1;l++)for(let u=0;u<o;u++){let o=_(l),d=_(l+1),ee=g(u);if(a>=o-4&&a<=d+4){let a=Math.abs(i-ee);if(a<c){c=a;let i=r(n(e(l,u),e(l+1,u)));s=t.lines[i]??null}}}return s}var se={"pt-BR":`🇧🇷`,"pt-PT":`🇵🇹`,es:`🇪🇸`,en:`🇬🇧`},ce=`dab_lang`;function le(){let e=localStorage.getItem(ce);if(e&&e in se)return e;let t=navigator.language??``;return t.startsWith(`pt-PT`)?`pt-PT`:t.startsWith(`pt`)?`pt-BR`:t.startsWith(`es`)?`es`:`en`}function ue(e){localStorage.setItem(ce,e)}function v(e,t){let n=de[le()][e]??de.en[e]??e;if(t)for(let[e,r]of Object.entries(t))n=n.replaceAll(`{${e}}`,String(r));return n}var de={"pt-BR":{tagline:`Conecte • Feche • Domine`,menu_arcade:`Arcade`,menu_arcade_sub:`{done}/{total} fases concluídas`,menu_bot:`Modo Treino`,menu_bot_sub:`7 dificuldades`,menu_multi:`Multijogador`,menu_multi_sub:`2 a 4 jogadores • Duplas ou Solo`,menu_tutorial:`Tutorial`,menu_tutorial_sub:`Aprenda a jogar`,back:`← Voltar`,lang_label:`Idioma`,energy_no:`⚡ Sem energia! Aguarde a recarga ou assista um anúncio.`,energy_recharged:`⚡ Energia recarregada!`,energy_unlimited:`∞`,settings:`Configurações`,theme:`Tema`,theme_dark:`🌙 Escuro`,theme_light:`☀️ Claro`,multiplatform:`Multiplataforma`,profile:`Perfil`,diff_muito_facil:`Muito Fácil`,diff_facil:`Fácil`,diff_medio:`Médio`,diff_dificil:`Difícil`,diff_muito_dificil:`Muito Difícil`,diff_impossivel:`Impossível`,diff_impulsivo:`Impulsivo`,setup_difficulty:`Dificuldade`,setup_grid:`Grade`,setup_players:`Jogadores`,setup_mode:`Modo`,setup_solo:`Solo (todos vs todos)`,setup_teams:`Duplas (2v2)`,setup_start:`Iniciar Partida`,game_turn:`Vez de {name}`,game_bot_thinking:`Bot pensando...`,stage_label:`Fase {id}`,vs_bot_label:`vs Bot — {diff}`,teams_2v2:`Duplas 2v2`,n_players:`{n} Jogadores`,team_a:`Time A`,team_b:`Time B`,stage_complete:`COMPLETA!`,next_stage:`Próxima Fase →`,map:`📍 Mapa`,victory:`Vitória!`,won_suffix:`venceu!`,tie:`🤝 Empate!`,new_game:`Nova Partida`,xp_gained:`+{xp} XP`,you_lost:`Você perdeu!`,you_tied:`🤝 Você empatou!`,try_again:`⚡ Tentar de novo`,watch_ad:`📺 Assistir anúncio`,skip_phase:`Deseja pular a fase?`,skip_via_ad:`📺 Pular com anúncio ({n} restantes)`,no_skips_left:`Sem pulos disponíveis esta semana`,god_skips:`Pulos disponíveis`,tut_step1_title:`Conecte os pontos`,tut_step1_desc:`Clique em dois pontos adjacentes para traçar uma linha.`,tut_step2_title:`Feche o quadrado`,tut_step2_desc:`Ao fechar o 4º lado de um quadrado você pontua e joga de novo.`,tut_step3_title:`Marque mais pontos`,tut_step3_desc:`Vence quem fechar mais quadrados quando todas as linhas acabarem.`,tut_step4_title:`Cuidado com o bot`,tut_step4_desc:`Não deixe o 3º lado de um quadrado aberto — o bot vai completar!`,tut_hint:`Cada ponto conecta-se aos vizinhos. Um quadrado tem 4 lados.`,ad_label:`ANÚNCIO`,ad_close_timer:`Fechar ({n})`,ad_close_ready:`✓ Fechar`,ad_text:`Baixe agora o melhor jogo!`,ad_cta:`JOGAR GRÁTIS`,god_mode:`👑 God Mode`,god_unlimited_energy:`Energia ilimitada`,god_go_stage:`Ir para fase específica`,god_go:`IR`,god_next:`⏭ Próxima fase ({id})`,god_refill:`⚡ Recarregar energia`,god_activated:`👑 God Mode ATIVADO!`,god_deactivated:`God Mode desativado`,on_label:`ON`,off_label:`OFF`,settings_vibration:`Vibração`,settings_music:`🎵 Volume da Música`,settings_sound:`🔊 Volume do Som`,settings_mute:`🔇 Mudo (sem sons)`,player_n:`Jogador {n}`,you:`Você`,bot:`Bot`,rank_master:`Mestre`,rank_diamond:`Diamante`,rank_plat_3:`Platina III`,rank_plat_2:`Platina II`,rank_plat_1:`Platina I`,rank_gold_3:`Ouro III`,rank_gold_2:`Ouro II`,rank_gold_1:`Ouro I`,rank_silver_3:`Prata III`,rank_silver_2:`Prata II`,rank_silver_1:`Prata I`,rank_bronze_3:`Bronze III`,rank_bronze_2:`Bronze II`,rank_bronze_1:`Bronze I`,rank_beginner:`Iniciante`},"pt-PT":{settings:`Definições`,theme:`Tema`,theme_dark:`🌙 Escuro`,theme_light:`☀️ Claro`,theme_pink:`🌸 Rosa`,multiplatform:`Multiplataforma`,profile:`Perfil`,tagline:`Conecte • Feche • Domine`,menu_arcade:`Arcade`,menu_arcade_sub:`{done}/{total} fases concluídas`,menu_bot:`Modo Treino`,menu_bot_sub:`7 dificuldades`,menu_multi:`Multijogador`,menu_multi_sub:`2 a 4 jogadores • Duplas ou Solo`,menu_tutorial:`Tutorial`,menu_tutorial_sub:`Aprenda a jogar`,back:`← Voltar`,lang_label:`Idioma`,energy_no:`⚡ Sem energia! Aguarde a recarga ou veja um anúncio.`,energy_recharged:`⚡ Energia recarregada!`,energy_unlimited:`∞`,diff_muito_facil:`Muito Fácil`,diff_facil:`Fácil`,diff_medio:`Médio`,diff_dificil:`Difícil`,diff_muito_dificil:`Muito Difícil`,diff_impossivel:`Impossível`,diff_impulsivo:`Impulsivo`,setup_difficulty:`Dificuldade`,setup_grid:`Grelha`,setup_players:`Jogadores`,setup_mode:`Modo`,setup_solo:`Solo (todos vs todos)`,setup_teams:`Duplas (2v2)`,setup_start:`Iniciar Jogo`,game_turn:`Vez de {name}`,game_bot_thinking:`Bot a pensar...`,stage_label:`Fase {id}`,vs_bot_label:`vs Bot — {diff}`,teams_2v2:`Duplas 2v2`,n_players:`{n} Jogadores`,team_a:`Equipa A`,team_b:`Equipa B`,stage_complete:`COMPLETA!`,next_stage:`Próxima Fase →`,map:`📍 Mapa`,victory:`Vitória!`,won_suffix:`venceu!`,tie:`🤝 Empate!`,new_game:`Novo Jogo`,xp_gained:`+{xp} XP`,you_lost:`Perdeu!`,you_tied:`🤝 Empatou!`,try_again:`⚡ Tentar novamente`,watch_ad:`📺 Ver anúncio`,skip_phase:`Deseja pular a fase?`,skip_via_ad:`📺 Pular com anúncio ({n} restantes)`,no_skips_left:`Sem pulos disponíveis esta semana`,god_skips:`Pulos disponíveis`,tut_step1_title:`Conecte os pontos`,tut_step1_desc:`Clique em dois pontos adjacentes para traçar uma linha.`,tut_step2_title:`Feche o quadrado`,tut_step2_desc:`Ao fechar o 4º lado de um quadrado você pontua e joga de novo.`,tut_step3_title:`Marque mais pontos`,tut_step3_desc:`Vence quem fechar mais quadrados quando todas as linhas acabarem.`,tut_step4_title:`Cuidado com o bot`,tut_step4_desc:`Não deixe o 3º lado de um quadrado aberto — o bot vai completar!`,tut_hint:`Cada ponto conecta-se aos vizinhos. Um quadrado tem 4 lados.`,ad_label:`ANÚNCIO`,ad_close_timer:`Fechar ({n})`,ad_close_ready:`✓ Fechar`,ad_text:`Descarregue agora o melhor jogo!`,ad_cta:`JOGAR GRÁTIS`,god_mode:`👑 God Mode`,god_unlimited_energy:`Energia ilimitada`,god_go_stage:`Ir para fase específica`,god_go:`IR`,god_next:`⏭ Próxima fase ({id})`,god_refill:`⚡ Recarregar energia`,god_activated:`👑 God Mode ATIVADO!`,god_deactivated:`God Mode desativado`,on_label:`ON`,off_label:`OFF`,settings_vibration:`Vibração`,settings_music:`🎵 Volume da Música`,settings_sound:`🔊 Volume do Som`,settings_mute:`🔇 Mudo (sem sons)`,player_n:`Jogador {n}`,you:`Você`,bot:`Bot`,rank_master:`Mestre`,rank_diamond:`Diamante`,rank_plat_3:`Platina III`,rank_plat_2:`Platina II`,rank_plat_1:`Platina I`,rank_gold_3:`Ouro III`,rank_gold_2:`Ouro II`,rank_gold_1:`Ouro I`,rank_silver_3:`Prata III`,rank_silver_2:`Prata II`,rank_silver_1:`Prata I`,rank_bronze_3:`Bronze III`,rank_bronze_2:`Bronze II`,rank_bronze_1:`Bronze I`,rank_beginner:`Iniciante`},es:{settings:`Ajustes`,theme:`Tema`,theme_dark:`🌙 Oscuro`,theme_light:`☀️ Claro`,theme_pink:`🌸 Rosa`,multiplatform:`Multiplataforma`,profile:`Perfil`,tagline:`Conecta • Cierra • Domina`,menu_arcade:`Arcade`,menu_arcade_sub:`{done}/{total} fases completadas`,menu_bot:`Modo Entrenamiento`,menu_bot_sub:`7 niveles de dificultad`,menu_multi:`Multijugador`,menu_multi_sub:`2 a 4 jugadores • Parejas o Solo`,menu_tutorial:`Tutorial`,menu_tutorial_sub:`Aprende a jugar`,back:`← Volver`,lang_label:`Idioma`,energy_no:`⚡ ¡Sin energía! Espera la recarga o ve un anuncio.`,energy_recharged:`⚡ ¡Energía recargada!`,energy_unlimited:`∞`,diff_muito_facil:`Muy Fácil`,diff_facil:`Fácil`,diff_medio:`Medio`,diff_dificil:`Difícil`,diff_muito_dificil:`Muy Difícil`,diff_impossivel:`Imposible`,diff_impulsivo:`Impulsivo`,setup_difficulty:`Dificultad`,setup_grid:`Cuadrícula`,setup_players:`Jugadores`,setup_mode:`Modo`,setup_solo:`Solo (todos vs todos)`,setup_teams:`Parejas (2v2)`,setup_start:`Iniciar Partida`,game_turn:`Turno de {name}`,game_bot_thinking:`Bot pensando...`,stage_label:`Fase {id}`,vs_bot_label:`vs Bot — {diff}`,teams_2v2:`Parejas 2v2`,n_players:`{n} Jugadores`,team_a:`Equipo A`,team_b:`Equipo B`,stage_complete:`¡COMPLETA!`,next_stage:`Siguiente Fase →`,map:`📍 Mapa`,victory:`¡Victoria!`,won_suffix:`¡ganó!`,tie:`🤝 ¡Empate!`,new_game:`Nueva Partida`,xp_gained:`+{xp} XP`,you_lost:`¡Perdiste!`,you_tied:`🤝 ¡Empataste!`,try_again:`⚡ Intentar de nuevo`,watch_ad:`📺 Ver anuncio`,skip_phase:`¿Deseas saltar la fase?`,skip_via_ad:`📺 Saltar con anuncio ({n} restantes)`,no_skips_left:`Sin saltos disponibles esta semana`,god_skips:`Saltos disponibles`,tut_step1_title:`Conecta los puntos`,tut_step1_desc:`Haz clic en dos puntos adyacentes para trazar una línea.`,tut_step2_title:`Cierra el cuadrado`,tut_step2_desc:`Al cerrar el 4º lado de un cuadrado puntúas y vuelves a jugar.`,tut_step3_title:`Más puntos gana`,tut_step3_desc:`Gana quien cierre más cuadrados cuando no queden líneas.`,tut_step4_title:`Cuidado con el bot`,tut_step4_desc:`No dejes el 3er lado abierto — ¡el bot lo completará!`,tut_hint:`Cada punto se conecta a sus vecinos. Un cuadrado tiene 4 lados.`,ad_label:`ANUNCIO`,ad_close_timer:`Cerrar ({n})`,ad_close_ready:`✓ Cerrar`,ad_text:`¡Descarga ahora el mejor juego!`,ad_cta:`JUGAR GRATIS`,god_mode:`👑 Modo Dios`,god_unlimited_energy:`Energía ilimitada`,god_go_stage:`Ir a fase específica`,god_go:`IR`,god_next:`⏭ Siguiente fase ({id})`,god_refill:`⚡ Recargar energía`,god_activated:`👑 ¡Modo Dios ACTIVADO!`,god_deactivated:`Modo Dios desactivado`,on_label:`ON`,off_label:`OFF`,settings_vibration:`Vibración`,settings_music:`🎵 Volumen de Música`,settings_sound:`🔊 Volumen de Sonido`,settings_mute:`🔇 Silencio (sin sonidos)`,player_n:`Jugador {n}`,you:`Tú`,bot:`Bot`,rank_master:`Maestro`,rank_diamond:`Diamante`,rank_plat_3:`Platino III`,rank_plat_2:`Platino II`,rank_plat_1:`Platino I`,rank_gold_3:`Oro III`,rank_gold_2:`Oro II`,rank_gold_1:`Oro I`,rank_silver_3:`Plata III`,rank_silver_2:`Plata II`,rank_silver_1:`Plata I`,rank_bronze_3:`Bronce III`,rank_bronze_2:`Bronce II`,rank_bronze_1:`Bronce I`,rank_beginner:`Principiante`},en:{settings:`Settings`,theme:`Theme`,theme_dark:`🌙 Dark`,theme_light:`☀️ Light`,theme_pink:`🌸 Pink`,multiplatform:`Multiplatform`,profile:`Profile`,tagline:`Connect • Close • Dominate`,menu_arcade:`Arcade`,menu_arcade_sub:`{done}/{total} stages completed`,menu_bot:`Training Mode`,menu_bot_sub:`7 difficulty levels`,menu_multi:`Multiplayer`,menu_multi_sub:`2 to 4 players • Teams or Solo`,menu_tutorial:`Tutorial`,menu_tutorial_sub:`Learn how to play`,back:`← Back`,lang_label:`Language`,energy_no:`⚡ No energy! Wait for recharge or watch an ad.`,energy_recharged:`⚡ Energy recharged!`,energy_unlimited:`∞`,diff_muito_facil:`Very Easy`,diff_facil:`Easy`,diff_medio:`Medium`,diff_dificil:`Hard`,diff_muito_dificil:`Very Hard`,diff_impossivel:`Impossible`,diff_impulsivo:`Impulsive`,setup_difficulty:`Difficulty`,setup_grid:`Grid Size`,setup_players:`Players`,setup_mode:`Mode`,setup_solo:`Solo (all vs all)`,setup_teams:`Teams (2v2)`,setup_start:`Start Game`,game_turn:`{name}'s turn`,game_bot_thinking:`Bot thinking...`,stage_label:`Stage {id}`,vs_bot_label:`vs Bot — {diff}`,teams_2v2:`Teams 2v2`,n_players:`{n} Players`,team_a:`Team A`,team_b:`Team B`,stage_complete:`COMPLETE!`,next_stage:`Next Stage →`,map:`📍 Map`,victory:`Victory!`,won_suffix:`won!`,tie:`🤝 Tie!`,new_game:`New Game`,xp_gained:`+{xp} XP`,you_lost:`You lost!`,you_tied:`🤝 It's a Tie!`,try_again:`⚡ Try Again`,watch_ad:`📺 Watch Ad`,skip_phase:`Want to skip this stage?`,skip_via_ad:`📺 Skip with ad ({n} left)`,no_skips_left:`No skips available this week`,god_skips:`Available skips`,tut_step1_title:`Connect the dots`,tut_step1_desc:`Click two adjacent dots to draw a line between them.`,tut_step2_title:`Close the square`,tut_step2_desc:`Close the 4th side of a square to score and play again.`,tut_step3_title:`Score the most`,tut_step3_desc:`The player who closes the most squares wins.`,tut_step4_title:`Watch the bot`,tut_step4_desc:`Don't leave the 3rd side open — the bot will complete it!`,tut_hint:`Each dot connects to its neighbors. A square has 4 sides.`,ad_label:`AD`,ad_close_timer:`Close ({n})`,ad_close_ready:`✓ Close`,ad_text:`Download the best game now!`,ad_cta:`PLAY FREE`,god_mode:`👑 God Mode`,god_unlimited_energy:`Unlimited energy`,god_go_stage:`Go to specific stage`,god_go:`GO`,god_next:`⏭ Next stage ({id})`,god_refill:`⚡ Refill energy`,god_activated:`👑 God Mode ACTIVATED!`,god_deactivated:`God Mode deactivated`,on_label:`ON`,off_label:`OFF`,settings_vibration:`Vibration`,settings_music:`🎵 Music Volume`,settings_sound:`🔊 Sound Volume`,settings_mute:`🔇 Mute (no sounds)`,player_n:`Player {n}`,you:`You`,bot:`Bot`,rank_master:`Master`,rank_diamond:`Diamond`,rank_plat_3:`Platinum III`,rank_plat_2:`Platinum II`,rank_plat_1:`Platinum I`,rank_gold_3:`Gold III`,rank_gold_2:`Gold II`,rank_gold_1:`Gold I`,rank_silver_3:`Silver III`,rank_silver_2:`Silver II`,rank_silver_1:`Silver I`,rank_bronze_3:`Bronze III`,rank_bronze_2:`Bronze II`,rank_bronze_1:`Bronze I`,rank_beginner:`Beginner`}},fe={"muito-facil":`diff_muito_facil`,facil:`diff_facil`,medio:`diff_medio`,dificil:`diff_dificil`,"muito-dificil":`diff_muito_dificil`,impossivel:`diff_impossivel`,impulsivo:`diff_impulsivo`};function pe(e){return v(fe[e])}var me=[`muito-facil`,`facil`,`medio`,`dificil`,`muito-dificil`,`impossivel`,`impulsivo`];function y(e){return e[Math.floor(Math.random()*e.length)]}function b(t,n,r){return a(e(n,r)).filter(e=>t.lines[e]?.ownerId!==null).length}function he(e,t){return t.filter(t=>{let{gridSize:n}=e;return x(t,n).some(([t,n])=>b(e,t,n)===3)})}function ge(e,t){return t.filter(t=>{let{gridSize:n}=e;return!x(t,n).some(([t,n])=>b(e,t,n)===2)})}function x(e,t){let n=[],{from:r,to:i}=e;if(r.row===i.row){let e=r.row,i=r.col;e>0&&n.push([e-1,i]),e<t-1&&n.push([e,i])}else{let e=r.row,i=r.col;i>0&&n.push([e,i-1]),i<t-1&&n.push([e,i])}return n}function _e(e,t){let n=e.players.find(e=>e.id===t),r=e.players.find(e=>e.id!==t);return(n?.score??0)-(r?.score??0)}function S(e,t,n,r,i,a){if(e.status===`finished`||n===0)return _e(e,t);let o=f(e);if(o.length===0)return _e(e,t);let s=[...o].sort((t,n)=>{let r=+!!x(t,e.gridSize).some(([t,n])=>b(e,t,n)===3);return+!!x(n,e.gridSize).some(([t,n])=>b(e,t,n)===3)-r});if(a){let a=-1/0;for(let o of s){let s=d(e,o);if(!s.ok)continue;let c=s.value.currentPlayerId===t,l=S(s.value,t,n-1,r,i,c);if(a=Math.max(a,l),r=Math.max(r,l),i<=r)break}return a}else{let a=1/0;for(let o of s){let s=d(e,o);if(!s.ok)continue;let c=s.value.currentPlayerId===t,l=S(s.value,t,n-1,r,i,c);if(a=Math.min(a,l),i=Math.min(i,l),i<=r)break}return a}}function C(e,t,n){let r=f(e),i=r[0],a=-1/0;for(let o of r){let r=d(e,o);if(!r.ok)continue;let s=r.value.currentPlayerId===t,c=S(r.value,t,n-1,-1/0,1/0,s);c>a&&(a=c,i=o)}return i}function ve(e,t){let n=f(e);if(n.length===0)throw Error(`Sem movimentos disponíveis`);let r=e.currentPlayerId;switch(t){case`muito-facil`:return y(n);case`facil`:{let t=he(e,n);return t.length>0&&Math.random()<.5?y(t):y(n)}case`medio`:{let t=he(e,n);if(t.length>0)return y(t);let r=ge(e,n);return r.length>0?y(r):y(n)}case`dificil`:return C(e,r,3);case`muito-dificil`:return C(e,r,6);case`impossivel`:return C(e,r,e.gridSize<=4?12:8);case`impulsivo`:return Math.random()<.4?C(e,r,8):y(n)}}function ye(e){return{"muito-facil":300,facil:400,medio:500,dificil:700,"muito-dificil":900,impossivel:1200,impulsivo:200}[e]}var w=[{range:[1,10],gridSizes:[3],difficulty:`muito-facil`},{range:[11,25],gridSizes:[3,4],difficulty:`muito-facil`},{range:[26,50],gridSizes:[4],difficulty:`facil`},{range:[51,80],gridSizes:[4],difficulty:`facil`},{range:[81,120],gridSizes:[4,5],difficulty:`medio`},{range:[121,170],gridSizes:[5],difficulty:`medio`},{range:[171,230],gridSizes:[5],difficulty:`dificil`},{range:[231,300],gridSizes:[5,6],difficulty:`dificil`},{range:[301,380],gridSizes:[6],difficulty:`muito-dificil`},{range:[381,450],gridSizes:[6],difficulty:`muito-dificil`},{range:[451,490],gridSizes:[6],difficulty:`impossivel`},{range:[491,500],gridSizes:[6],difficulty:`impossivel`}];function be(e,t){let n=(t-1)*(t-1),r=e%5;if(r===0)return{objectiveType:`dominance`,objectiveValue:60,stars:[`Vença`,`Feche ≥60% das caixas`,`Feche ≥75% das caixas`]};if(r===1){let t=Math.min(2+Math.floor(e/50),Math.floor(n/2));return{objectiveType:`margin`,objectiveValue:t,stars:[`Vença`,`Vença por ≥${t} caixas`,`Vença por ≥${t+2} caixas`]}}return r===2?{objectiveType:`chain`,objectiveValue:2,stars:[`Vença`,`Feche ≥2 caixas em um turno`,`Feche ≥3 caixas em um turno`]}:r===3?{objectiveType:`clean`,objectiveValue:0,stars:[`Vença`,`Vença sem dar caixas ao bot`,`Vença sem dar caixas com margem ≥3`]}:{objectiveType:`win`,objectiveValue:0,stars:[`Vença`,`Vença com ≥${Math.ceil(n*.5)} caixas`,`Vença com ≥${Math.ceil(n*.65)} caixas`]}}function xe(e){let t=w.find(t=>e>=t.range[0]&&e<=t.range[1])??w[w.length-1],n=t.gridSizes,r=n[e%n.length]??n[0],i=be(e,r);return{id:e,gridSize:r,difficulty:t.difficulty,...i}}var T=`dab_skips`;function Se(){let e=new Date;return e.setHours(0,0,0,0),e.setDate(e.getDate()-(e.getDay()+6)%7),e.getTime()}function E(){try{let e=localStorage.getItem(T);if(e){let t=JSON.parse(e);if(t.weekStart>=Se())return t}}catch{}let e={count:3,weekStart:Se()};return localStorage.setItem(T,JSON.stringify(e)),e}function Ce(){return E().count}function we(){let e=E();return e.count<=0?!1:(e.count--,localStorage.setItem(T,JSON.stringify(e)),!0)}function Te(e){let t=E();t.count=Math.max(0,e),localStorage.setItem(T,JSON.stringify(t))}var Ee=`dab_music_vol`,De=`dab_mute`;function Oe(){return localStorage.getItem(De)===`1`}function ke(e){localStorage.setItem(De,e?`1`:`0`)}function Ae(){let e=localStorage.getItem(Ee);return e===null?.25:Math.max(0,Math.min(1,parseFloat(e)))}function je(e){localStorage.setItem(Ee,String(Math.max(0,Math.min(1,e))))}var Me=`dab_vibration`;function Ne(){let e=localStorage.getItem(Me);return e===null?!0:e===`1`}function Pe(e){localStorage.setItem(Me,e?`1`:`0`)}function Fe(e){if(Ne())try{typeof window<`u`&&window.navigator?.vibrate&&window.navigator.vibrate(e)}catch{}}var Ie=`dab_theme`;function D(){return localStorage.getItem(Ie)??`dark`}function Le(e){localStorage.setItem(Ie,e),document.documentElement.setAttribute(`data-theme`,e)}function Re(){document.documentElement.setAttribute(`data-theme`,D())}var ze=`dab_profile`;function Be(){return{name:`Jogador`,xp:0,stageProgress:{}}}function Ve(){try{let e=localStorage.getItem(ze);return e?JSON.parse(e):Be()}catch{return Be()}}function He(e){localStorage.setItem(ze,JSON.stringify(e))}function Ue(e,t,n,r){let i=Ve(),a=i.stageProgress[e];return i.stageProgress[e]={stars:Math.max(t,a?.stars??0),bestScore:Math.max(n,a?.bestScore??0)},i.xp+=r,He(i),i}function We(e){let t=[{key:`rank_master`,icon:`👑`,min:15e4,next:1/0},{key:`rank_diamond`,icon:`🔷`,min:75e3,next:15e4},{key:`rank_plat_3`,icon:`💎`,min:5e4,next:75e3},{key:`rank_plat_2`,icon:`💎`,min:4e4,next:5e4},{key:`rank_plat_1`,icon:`💎`,min:3e4,next:4e4},{key:`rank_gold_3`,icon:`🥇`,min:2e4,next:3e4},{key:`rank_gold_2`,icon:`🥇`,min:15e3,next:2e4},{key:`rank_gold_1`,icon:`🥇`,min:1e4,next:15e3},{key:`rank_silver_3`,icon:`🥈`,min:6e3,next:1e4},{key:`rank_silver_2`,icon:`🥈`,min:3500,next:6e3},{key:`rank_silver_1`,icon:`🥈`,min:2500,next:3500},{key:`rank_bronze_3`,icon:`🥉`,min:1500,next:2500},{key:`rank_bronze_2`,icon:`🥉`,min:1e3,next:1500},{key:`rank_bronze_1`,icon:`🥉`,min:500,next:1e3},{key:`rank_beginner`,icon:`⚪`,min:0,next:500}],n=t.find(t=>e>=t.min)??t[t.length-1];return{rank:v(n.key),icon:n.icon,next:n.next}}var Ge=6e4,Ke=`dab_energy`;function qe(){try{let e=localStorage.getItem(Ke);if(!e)return 15;let t=JSON.parse(e),n=Math.floor((Date.now()-t.lastSaved)/Ge);return Math.min(15,t.amount+n)}catch{return 15}}function Je(e){localStorage.setItem(Ke,JSON.stringify({amount:e,lastSaved:Date.now()}))}function Ye(){let e=qe();return e<=0?!1:(Je(e-1),!0)}function Xe(){Je(15)}var Ze=`dab_god`;function Qe(){try{let e=localStorage.getItem(Ze);return e?JSON.parse(e):{unlimitedEnergy:!1}}catch{return{unlimitedEnergy:!1}}}function $e(e){localStorage.setItem(Ze,JSON.stringify(e))}var et=`xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"`,tt=`<path stroke="none" d="M0 0h24v24H0z" fill="none"/>`;function O(e,t){return`<svg ${et} width="${e}" height="${e}" viewBox="0 0 24 24">${tt}${t}</svg>`}function nt(e,t){return`<svg xmlns="http://www.w3.org/2000/svg" width="${e}" height="${e}" viewBox="0 0 24 24" fill="currentColor">${tt}${t}</svg>`}var k=22,rt=16,A=O(k,`<path d="M2 12h1"/><path d="M6 8h-2a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2"/><path d="M6 7v10a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-10a1 1 0 0 0-1-1h-1a1 1 0 0 0-1 1"/><path d="M9 12h6"/><path d="M15 7v10a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-10a1 1 0 0 0-1-1h-1a1 1 0 0 0-1 1"/><path d="M18 8h2a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-2"/><path d="M22 12h-1"/>`),j=O(k,`<path d="M5 7a4 4 0 1 0 8 0a4 4 0 1 0-8 0"/><path d="M3 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/><path d="M21 21v-2a4 4 0 0 0-3-3.85"/>`),it=O(k,`<path d="M3 19a9 9 0 0 1 9 0a9 9 0 0 1 9 0"/><path d="M3 6a9 9 0 0 1 9 0a9 9 0 0 1 9 0"/><path d="M3 6l0 13"/><path d="M12 6l0 13"/><path d="M21 6l0 13"/>`),at=O(rt,`<path d="M4 10l0 6"/><path d="M20 10l0 6"/><path d="M7 9h10v8a1 1 0 0 1-1 1h-8a1 1 0 0 1-1-1v-8a5 5 0 0 1 10 0"/><path d="M8 3l1 2"/><path d="M16 3l-1 2"/><path d="M9 18l0 3"/><path d="M15 18l0 3"/>`),ot=O(rt,`<path d="M8.286 7.008c-3.216 0-4.286 3.23-4.286 5.92c0 3.229 2.143 8.072 4.286 8.072c1.165-.05 1.799-.538 3.214-.538c1.406 0 1.607.538 3.214.538s4.286-3.229 4.286-5.381c-.03-.011-2.649-.434-2.679-3.23c-.02-2.335 2.589-3.179 2.679-3.228c-1.096-1.606-3.162-2.113-3.75-2.153c-1.535-.12-3.032 1.077-3.75 1.077c-.729 0-2.036-1.077-3.214-1.077"/><path d="M12 4a2 2 0 0 0 2-2a2 2 0 0 0-2 2"/>`),st=O(rt,`<path d="M3 5h6v14h-6l0-14"/><path d="M12 9h10v7h-10l0-7"/><path d="M14 19h6"/><path d="M17 16v3"/><path d="M6 13v.01"/><path d="M6 16v.01"/>`),M=O(k,`<path d="M12 17.75l-6.172 3.245l1.179-6.873l-5-4.867l6.9-1l3.086-6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873l-6.158-3.245"/>`),N=16,ct=O(N,`<path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1-8.313-12.454l0 .008"/><path d="M17 4a2 2 0 0 0 2 2a2 2 0 0 0-2 2a2 2 0 0 0-2-2a2 2 0 0 0 2-2"/><path d="M19 11h2m-1-1v2"/>`),lt=nt(N,`<path d="M12 19a1 1 0 0 1 .993 .883l.007 .117v1a1 1 0 0 1-1.993 .117l-.007-.117v-1a1 1 0 0 1 1-1z"/><path d="M18.313 16.91l.094 .083l.7 .7a1 1 0 0 1-1.32 1.497l-.094-.083l-.7-.7a1 1 0 0 1 1.218-1.567l.102 .07z"/><path d="M7.007 16.993a1 1 0 0 1 .083 1.32l-.083 .094l-.7 .7a1 1 0 0 1-1.497-1.32l.083-.094l.7-.7a1 1 0 0 1 1.414 0z"/><path d="M4 11a1 1 0 0 1 .117 1.993l-.117 .007h-1a1 1 0 0 1-.117-1.993l.117-.007h1z"/><path d="M21 11a1 1 0 0 1 .117 1.993l-.117 .007h-1a1 1 0 0 1-.117-1.993l.117-.007h1z"/><path d="M6.213 4.81l.094 .083l.7 .7a1 1 0 0 1-1.32 1.497l-.094-.083l-.7-.7a1 1 0 0 1 1.217-1.567l.102 .07z"/><path d="M19.107 4.893a1 1 0 0 1 .083 1.32l-.083 .094l-.7 .7a1 1 0 0 1-1.497-1.32l.083-.094l.7-.7a1 1 0 0 1 1.414 0z"/><path d="M12 2a1 1 0 0 1 .993 .883l.007 .117v1a1 1 0 0 1-1.993 .117l-.007-.117v-1a1 1 0 0 1 1-1z"/><path d="M12 7a5 5 0 1 1-4.995 5.217l-.005-.217l.005-.217a5 5 0 0 1 4.995-4.783z"/>`),P=O(N,`<path d="M10.325 4.317a1.95 1.95 0 0 1 3.35 0l.24 .392a1.95 1.95 0 0 0 1.155 .857l.45 .12a1.95 1.95 0 0 1 1.454 2.138l-.067 .462a1.95 1.95 0 0 0 .39 1.535l.295 .355a1.95 1.95 0 0 1 0 2.5l-.295 .355a1.95 1.95 0 0 0-.39 1.535l.067 .462a1.95 1.95 0 0 1-1.454 2.138l-.45 .12a1.95 1.95 0 0 0-1.155 .857l-.24 .392a1.95 1.95 0 0 1-3.35 0l-.24 -.392a1.95 1.95 0 0 0-1.155 -.857l-.45 -.12a1.95 1.95 0 0 1-1.454 -2.138l.067 -.462a1.95 1.95 0 0 0-.39 -1.535l-.295 -.355a1.95 1.95 0 0 1 0 -2.5l.295 -.355a1.95 1.95 0 0 0 .39 -1.535l-.067 -.462a1.95 1.95 0 0 1 1.454 -2.138l.45 -.12a1.95 1.95 0 0 0 1.155 -.857l.24 -.392z"/><circle cx="12" cy="12" r="3"/>`),ut=O(N,`<path d="M3 5a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-8a2 2 0 0 1 -2 -2l0 -14"/><path d="M8 4l2 0"/><path d="M9 17l0 .01"/><path d="M21 6l-2 3l2 3l-2 3l2 3"/>`),dt=`v0.01.34`,F=null,I=null,L=Qe(),R=document.getElementById(`app`),z=[`#e74c3c`,`#3498db`,`#2ecc71`,`#f39c12`];Re();function B(e,t){return`
    ...
    <span class="rank-ring-icon">${n.icon}</span>`}function U(){let e=L.unlimitedEnergy?15:qe(),t=e/15*100;return`
    <div class="energy-row">
      <span class="energy-bolt">⚡</span>
      <span class="energy-count">${L.unlimitedEnergy?`∞`:`${e}/15`}</span>
    ...
    </div>`}function gt(e=3200){let t=document.createElement(`canvas`);Object.assign(t.style,{position:`fixed`,top:`0`,left:`0`,width:`100%`,height:`100%`,pointerEvents:`none`,zIndex:`998`}),t.width=window.innerWidth,t.height=window.innerHeight,document.body.appendChild(t);let n=t.getContext(`2d`),r=[`#e74c3c`,`#3498db`,`#2ecc71`,`#f39c12`,`#9b59b6`,`#1abc9c`,`#e67e22`,`#ff6b9d`],i=Array.from({length:160},()=>({x:Math.random()*t.width,y:-20-Math.random()*120,w:5+Math.random()*9,h:3+Math.random()*5,color:r[Math.floor(Math.random()*r.length)],vx:(Math.random()-.5)*3,vy:1.5+Math.random()*4,rot:Math.random()*Math.PI*2,drot:(Math.random()-.5)*.15,opacity:1})),a=Date.now();(function r(){let o=(Date.now()-a)/e;n.clearRect(0,0,t.width,t.height);for(let e of i)e.x+=e.vx,e.y+=e.vy,e.rot+=e.drot,o>.65&&(e.opacity=Math.max(0,1-(o-.65)/.35)),n.save(),n.globalAlpha=e.opacity,n.translate(e.x,e.y),n.rotate(e.rot),n.fillStyle=e.color,n.fillRect(-e.w/2,-e.h/2,e.w,e.h),n.restore();o<1?requestAnimationFrame(r):t.remove()})()}var _t=[`Parabéns!`,`Mandou muito!`,`Excelente!`,`Perfeito!`,`Arrasou!`,`Show demais!`,`Você brilhou!`,`Sensacional!`,`Incrível!`,`Missão completa!`,`Jogada perfeita!`,`Resultado top!`,`Você dominou!`,`Que vitória!`,`Muito bem!`,`Desempenho incrível!`,`Nota máxima!`,`Você é fera!`,`Trabalho impecável!`,`Vitória com estilo!`],vt=[`Boa!`,`Legal!`,`Foi bem!`,`Bom trabalho!`,`Quase lá!`,`Continue assim!`,`Bom resultado!`,`Mandou bem!`,`Boa tentativa!`,`Está evoluindo!`,`Nada mal!`,`Segue firme!`,`Bom avanço!`,`Você conseguiu!`,`Tá no caminho!`,`Bem jogado!`,`Foi positivo!`,`Boa partida!`,`Progresso feito!`,`Mais uma etapa!`],yt=[`Bom trabalho!`,`Boa jogada!`,`Foi muito bem!`,`Continue assim!`,`Segue firme!`,`Boa partida!`,`Mandou bem!`,`Você conseguiu!`],bt=[`Não foi dessa vez!`,`Quase lá!`,`Tente novamente!`,`Você consegue!`,`Foi por pouco!`,`Continue tentando!`,`A próxima é sua!`,`Não desista!`,`Boa tentativa!`,`Hora da revanche!`,`Mais uma chance!`,`Você está evoluindo!`,`Faz parte do jogo!`,`Dá para virar!`,`Vamos de novo!`,`Aprendizado feito!`,`Faltou pouco!`,`Na próxima vai!`,`Respira e tenta de novo!`,`O jogo ainda não acabou!`],xt=[`Empate!`,`Deu empate!`,`Jogo equilibrado!`,`Foi parelho!`,`Ninguém levou!`,`Disputa acirrada!`,`Boa partida!`,`Bem disputado!`,`Quase vitória!`,`Equilíbrio total!`,`Jogo justo!`,`Batalha equilibrada!`,`Ficou no empate!`,`Ninguém cedeu!`,`Partida apertada!`,`Resultado equilibrado!`,`Deu tudo igual!`,`Grande disputa!`,`Um duelo de respeito!`,`Hora da revanche!`];function St(e){let t=e>=3?_t:e===2?vt:yt;return t[Math.floor(Math.random()*t.length)]}function Ct(e){let t=e?xt:bt;return t[Math.floor(Math.random()*t.length)]}function W(e,t,n,r,i,a,o){gt();let s=document.createElement(`div`);s.className=`cel-overlay`;let c=[0,1,2].map(t=>`<span class="cel-star ${t<e?`earned`:`empty`}" style="animation-delay:${.4+t*.25}s">★</span>`).join(``);s.innerHTML=`
    <div class="cel-card">
      ${n?`<div class="cel-label">${n}</div>`:``}
      <div class="cel-title">${o??v(`stage_complete`)}</div>
      <div class="cel-stars">${c}</div>
      <div class="cel-phrase">${St(e)}</div>
      ${t>0?`<div class="cel-xp">${v(`xp_gained`,{xp:t})}</div>`:``}
      <div class="cel-actions" id="cel-actions">
        ${r?`<button class="btn-cel-next" id="btn-cel-next">${v(`next_stage`)}</button>`:``}
        <button class="btn-cel-map" id="btn-cel-map">${v(`map`)}</button>
      </div>
    </div>`,document.body.appendChild(s);let l=s.querySelector(`#cel-actions`);l.style.opacity=`0`,setTimeout(()=>{l.style.opacity=`1`,l.style.transition=`opacity 0.4s`},2200),s.querySelector(`#btn-cel-next`)?.addEventListener(`click`,()=>{s.remove(),i()}),s.querySelector(`#btn-cel-map`)?.addEventListener(`click`,()=>{s.remove(),a()})}function G(e,t,n=!1,r){let i=!n&&r?`
    <div class="fail-skip-section">
      <span class="fail-skip-label">${v(`skip_phase`)}</span>
      ${r.available>0?`<button class="btn-ad" id="fa">${v(`skip_via_ad`,{n:r.available})}</button>`:`<span class="no-skips-label">${v(`no_skips_left`)}</span>`}
    </div>`:``,a=document.createElement(`div`);a.className=`fail-overlay`,a.innerHTML=`
    <div class="fail-card">
      <div class="fail-emoji">${n?`🤝`:`😞`}</div>
      <div class="fail-title">${v(n?`you_tied`:`you_lost`)}</div>
      <div class="fail-phrase">${Ct(n)}</div>
      <div class="fail-actions">
        <button class="btn-retry-pay" id="fr">${v(`try_again`)}</button>
        <button class="btn-cel-map" id="fm">${v(`map`)}</button>
      </div>
      ${i}
    </div>`,document.body.appendChild(a),a.querySelector(`#fr`)?.addEventListener(`click`,()=>{a.remove(),e()}),a.querySelector(`#fm`)?.addEventListener(`click`,()=>{a.remove(),t()}),a.querySelector(`#fa`)?.addEventListener(`click`,()=>{a.remove(),r?.onSkip()})}function wt(e){let t=document.createElement(`div`);t.className=`ad-overlay`,t.innerHTML=`
    <div class="ad-card">
      <div class="ad-top"><span class="ad-tag">${v(`ad_label`)}</span><span class="ad-timer" id="at">5</span></div>
      <div class="ad-mock"><div class="ad-logo">🎮</div><div class="ad-text">${v(`ad_text`)}</div><div class="ad-cta">${v(`ad_cta`)}</div></div>
      <div class="ad-progress-wrap"><div class="ad-progress" id="ap"></div></div>
      <button class="btn-close-ad" id="ac" disabled>${v(`ad_close_timer`,{n:5})}</button>
    </div>`,document.body.appendChild(t);let n=5,r=t.querySelector(`#at`),i=t.querySelector(`#ac`),a=t.querySelector(`#ap`);a.style.transition=`width ${n}s linear`,requestAnimationFrame(()=>{a.style.width=`100%`});let o=setInterval(()=>{n--,r.textContent=String(n),i.textContent=n>0?v(`ad_close_timer`,{n}):v(`ad_close_ready`),n<=0&&(clearInterval(o),i.disabled=!1,i.classList.add(`ready`))},1e3);i.addEventListener(`click`,()=>{t.remove(),e()})}function Tt(){let e=D(),t=document.createElement(`div`);t.className=`modal-overlay`,t.innerHTML=`
    <div class="modal-card">
      ...
      <div class="settings-section">
        <label class="settings-label">${v(`theme`)}</label>
        <div class="theme-row">
          <button class="btn-theme-opt ${e===`dark`?`active`:``}" data-theme="dark" title="${v(`theme_dark`)}">${ct}</button>
          <button class="btn-theme-opt ${e===`light`?`active`:``}" data-theme="light" title="${v(`theme_light`)}">${lt}</button>
          <button class="btn-theme-opt ${e===`pink`?`active`:``}" data-theme="pink" title="${v(`theme_pink`)}">🌸</button>
        </div>
      </div>
      <div class="settings-section">
        <label class="settings-label">${v(`lang_label`)}</label>
        <div class="lang-selector settings-lang">${jt()}</div>
      </div>
      <div class="settings-section">
        <div class="god-row">
          <label class="god-label settings-vibration-label">
            <span class="settings-vibration-icon">${ut}</span>
            <span>${v(`settings_vibration`)}</span>
          </label>
          <label class="toggle-switch" id="sv-wrap">
            <input type="checkbox" id="sv" ${Ne()?`checked`:``}>
      ...
      <div class="settings-section">
        <div class="god-row">
          <label class="god-label">${v(`settings_mute`)}</label>
          <label class="toggle-switch">
            <input type="checkbox" id="sm" ${Oe()?`checked`:``}>
            <span class="toggle-track"></span>
          </label>
        </div>
      </div>
      <div class="settings-section" id="music-vol-section" style="${Oe()?`opacity:.4;pointer-events:none`:``}">
        <label class="settings-label">${v(`settings_music`)}</label>
        <div class="music-vol-row">
          <span class="music-vol-icon">🔇</span>
          <input class="music-vol-slider" id="music-vol" type="range" min="0" max="100" value="${Math.round(Ae()*100)}" />
          <span class="music-vol-icon">🔊</span>
          <span class="music-vol-pct" id="music-vol-pct">${Math.round(Ae()*100)}%</span>
        </div>
      </div>
      <div class="settings-section" id="sound-vol-section" style="opacity:.45;pointer-events:none">
        <label class="settings-label">${v(`settings_sound`)}</label>
        <div class="music-vol-row">
          <span class="music-vol-icon">🔈</span>
      ...
      <div class="settings-version">${dt}</div>
    </div>`,document.body.appendChild(t),t.querySelector(`#mc`)?.addEventListener(`click`,()=>t.remove()),t.addEventListener(`click`,e=>{e.target===t&&t.remove()}),t.querySelectorAll(`.btn-theme-opt`).forEach(e=>{e.onclick=()=>{Le(e.dataset.theme),t.querySelectorAll(`.btn-theme-opt`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`)}}),t.querySelectorAll(`.btn-lang`).forEach(e=>{e.onclick=()=>{ue(e.dataset.lang),t.remove(),X()}}),t.querySelector(`#sv`)?.addEventListener(`change`,e=>{let t=e.target.checked;Pe(t),t&&Fe(30)}),t.querySelector(`#sm`)?.addEventListener(`change`,e=>{let n=e.target.checked;ke(n),V.muted=n;let r=t.querySelector(`#music-vol-section`);r&&(r.style.opacity=n?`.4`:``,r.style.pointerEvents=n?`none`:``)}),t.querySelector(`#music-vol`)?.addEventListener(`input`,e=>{let n=parseInt(e.target.value,10)/100;je(n),V.volume=n;let r=t.querySelector(`#music-vol-pct`);r&&(r.textContent=`${Math.round(n*100)}%`),V.paused&&n>0&&V.play().catch(()=>{})})}function Et(e){let t=document.createElement(`div`);t.className=`modal-overlay`,t.innerHTML=`
    <div class="modal-card god-card">
      <div class="modal-header">${B(P,v(`god_mode`))}<button class="modal-close" id="gc">✕</button></div>
      <div class="settings-section">
        <div class="god-row">
          <label class="god-label">${v(`god_unlimited_energy`)}</label>
          <button class="god-toggle ${L.unlimitedEnergy?`on`:``}" id="ge">${L.unlimitedEnergy?v(`on_label`):v(`off_label`)}</button>
        </div>
      </div>
      <div class="settings-section">
        <div class="god-row">
          <label class="god-label">${v(`god_skips`)} <span id="skip-count-label">${Ce()}/3</span></label>
          <button class="god-go" id="gsr">${v(`god_refill`)}</button>
        </div>
      </div>
      <div class="settings-section">
        <label class="settings-label">${v(`god_go_stage`)}</label>
        <div class="god-input-row">
          <input class="god-input" id="gs" type="number" min="1" max="500" placeholder="1-500" value="${e??1}" />
          <button class="god-go" id="gg">${v(`god_go`)}</button>
        </div>
      </div>
      ${e?`<button class="god-skip" id="gsk">${v(`god_next`,{id:e+1})}</button>`:``}
      <button class="god-refill" id="gr">${v(`god_refill`)}</button>
    </div>`,document.body.appendChild(t),t.querySelector(`#gc`)?.addEventListener(`click`,()=>t.remove()),t.addEventListener(`click`,e=>{e.target===t&&t.remove()});let n=t.querySelector(`#ge`);n.addEventListener(`click`,()=>{L.unlimitedEnergy=!L.unlimitedEnergy,$e(L),n.textContent=L.unlimitedEnergy?v(`on_label`):v(`off_label`),n.classList.toggle(`on`,L.unlimitedEnergy),Dt()}),t.querySelector(`#gr`)?.addEventListener(`click`,()=>{Xe(),Dt(),K(v(`energy_recharged`))}),t.querySelector(`#gsr`)?.addEventListener(`click`,()=>{Te(3),t.querySelector(`#skip-count-label`).textContent=`3/3`,K(`3 pulos restaurados`)}),t.querySelector(`#gg`)?.addEventListener(`click`,()=>{let e=parseInt(t.querySelector(`#gs`).value,10);e>=1&&e<=500&&(t.remove(),F=null,I=null,Q(e,!0))}),t.querySelector(`#gsk`)?.addEventListener(`click`,()=>{e&&(t.remove(),F=null,I=null,Q(e+1,!0))})}function K(e){document.querySelectorAll(`.toast`).forEach(e=>e.remove());let t=document.createElement(`div`);t.className=`toast`,t.textContent=e,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add(`show`)}),setTimeout(()=>{t.classList.remove(`show`),setTimeout(()=>t.remove(),400)},2200)}var q=null;function Dt(){document.querySelectorAll(`#energy-display`).forEach(e=>{e.innerHTML=U()})}function Ot(){q&&clearInterval(q),q=setInterval(Dt,15e3)}function J(){q&&=(clearInterval(q),null)}var kt={"pt-BR":`Português Brasil`,"pt-PT":`Português Portugal`,es:`Espanhol`,en:`Inglês`},At={"pt-BR":`br`,"pt-PT":`pt`,es:`es`,en:`gb`};function jt(){let e=le();return Object.keys(kt).map(t=>`<button class="btn-lang ${t===e?`active`:``}" data-lang="${t}" title="${kt[t]}" aria-label="${kt[t]}"><span class="fi fi-${At[t]} fi-flag-icon"></span></button>`).join(``)}function Mt(){return`<div class="lang-selector">${jt()}</div>`}function Nt(e=document){e.querySelectorAll(`.btn-lang`).forEach(e=>{e.onclick=()=>{ue(e.dataset.lang),X()}})}var Y=0,Pt=null;function X(){J(),F=null,I=null;let e=Ve(),t=We(e.xp),n=Object.values(e.stageProgress).filter(e=>e.stars>0).length,r=n===0;R.innerHTML=`
    <div class="screen menu-screen">

      <div class="topbar">
        <div></div>
        <div class="topbar-right">
          <button class="btn-settings-pill" id="btn-settings" title="${v(`settings`)}" aria-label="${v(`settings`)}">${P}<span>${v(`settings`)}</span></button>
          <button class="btn-profile-icon" id="btn-profile" title="${v(`profile`)}">
      ...
      <div class="menu-logo" id="menu-title">
        <h1>Dots &amp; Boxes</h1>
        <p class="menu-tagline">${v(`tagline`)}</p>
      </div>
      ...
      <div class="rank-card">
        ...
        ${L.unlimitedEnergy?`<button class="btn-god-ring" id="btn-god-menu">👑</button>`:``}
      </div>

      <div id="energy-display">${U()}</div>

      <div class="menu-buttons">
        <button class="btn-menu btn-arcade" id="btn-arcade">
          <div class="btn-menu-icon-wrap btn-icon--arcade">${M}</div>
          <div class="btn-menu-text">
            <strong>${v(`menu_arcade`)}</strong>
            <small>${v(`menu_arcade_sub`,{done:n,total:50})}</small>
          </div>
          ${r?`<span class="badge-new">NEW</span>`:``}
        </button>
        <button class="btn-menu btn-bot" id="btn-bot">
          <div class="btn-menu-icon-wrap btn-icon--bot">${A}</div>
          <div class="btn-menu-text">
            <strong>${v(`menu_bot`)}</strong>
            <small>${v(`menu_bot_sub`)}</small>
          </div>
        </button>
        <button class="btn-menu btn-multi" id="btn-multi">
          <div class="btn-menu-icon-wrap btn-icon--multi">${j}</div>
          <div class="btn-menu-text">
            <strong>${v(`menu_multi`)}</strong>
            <small>${v(`menu_multi_sub`)}</small>
          </div>
        </button>
      </div>
      ...
      <button class="btn-menu btn-tutorial" id="btn-tutorial">
        <div class="btn-menu-icon-wrap btn-icon--tutorial">${it}</div>
        <div class="btn-menu-text">
          <strong>${v(`menu_tutorial`)}</strong>
          <small>${v(`menu_tutorial_sub`)}</small>
        </div>
      </button>

      <div class="theme-toggle-wrap">
        <button class="theme-toggle-opt ${D()===`dark`?`active`:``}" data-t="dark" title="${v(`theme_dark`).replace(/^.\s/,``)}">${ct}</button>
        <button class="theme-toggle-opt ${D()===`light`?`active`:``}" data-t="light" title="${v(`theme_light`).replace(/^.\s/,``)}">${lt}</button>
        <button class="theme-toggle-opt ${D()===`pink`?`active`:``}" data-t="pink" title="${v(`theme_pink`).replace(/^.\s/,``)}">🌸</button>
      </div>

      <div class="bottom-bar">
        <div class="platform-pills">
          <span class="platform-pill">${st} PC</span>
          <span class="platform-pill">${at} Android</span>
          <span class="platform-pill">${ot} IOS</span>
        </div>
        <div class="bottom-star">✦</div>
        <div class="version-tag">${dt}</div>
      </div>

    </div>`,Ot(),document.getElementById(`btn-arcade`).onclick=Z,document.getElementById(`btn-bot`).onclick=Lt,document.getElementById(`btn-multi`).onclick=Rt,document.getElementById(`btn-tutorial`).onclick=zt,document.querySelectorAll(`.theme-toggle-opt`).forEach(e=>{e.onclick=()=>{Le(e.dataset.t),X()}}),document.getElementById(`btn-settings`).onclick=Tt,document.getElementById(`btn-profile`)?.addEventListener(`click`,()=>K(`👤 `+v(`profile`)+` — em breve!`)),document.getElementById(`btn-god-menu`)?.addEventListener(`click`,()=>Et()),Nt(),document.getElementById(`menu-title`).addEventListener(`click`,()=>{Y++,Pt&&clearTimeout(Pt),Pt=setTimeout(()=>{Y=0},3e3),Y>=7&&(Y=0,L.unlimitedEnergy=!L.unlimitedEnergy,$e(L),K(L.unlimitedEnergy?v(`god_activated`):v(`god_deactivated`)),X())})}function Z(){J();let e=Ve(),t=``;for(let n=1;n<=50;n++){let r=e.stageProgress[n]?.stars??0,i=n===1||(e.stageProgress[n-1]?.stars??0)>0,a=`★`.repeat(r)+`☆`.repeat(3-r);t+=`<button class="stage-cell ${i?`unlocked`:`locked`} stars-${r}" data-stage="${n}" ${i?``:`disabled`}>
      <span class="stage-num">${n}</span><span class="stage-stars">${a}</span></button>`}R.innerHTML=`
    <div class="screen arcade-screen">
      <div class="screen-header">
        <button class="btn-back" id="btn-back">${v(`back`)}</button>
        <h2>${B(M,v(`menu_arcade`))}</h2>
        <div id="energy-display" style="font-size:.75rem">${U()}</div>
      </div>
      <div class="stage-grid">${t}</div>
    </div>`,Ot(),document.getElementById(`btn-back`).onclick=X,document.querySelectorAll(`.stage-cell.unlocked`).forEach(e=>{e.onclick=()=>Q(parseInt(e.dataset.stage,10))})}var Ft={"muito-facil":{icon:`☆`,tier:`easy`},facil:{icon:`☆`,tier:`easy`},medio:{icon:`😊`,tier:`easy`},dificil:{icon:`😠`,tier:`hard`},"muito-dificil":{icon:`😠`,tier:`hard`},impossivel:{icon:`💀`,tier:`hard`},impulsivo:{icon:`🎲`,tier:`wild`}};function It(e){return`<div class="dot-grid-preview" style="grid-template-columns:repeat(${e},1fr)">${Array.from({length:e*e},()=>`<span class="dot-preview"></span>`).join(``)}</div>`}function Lt(){J(),R.innerHTML=`
    <div class="screen setup-screen">
      <div class="screen-header">
        <button class="btn-back" id="btn-back">${v(`back`)}</button>
        <h2>${B(A,v(`menu_bot`))}</h2>
        <span class="header-end-spacer"></span>
      </div>
      <div class="setup-section">
        <label class="setup-label">${v(`setup_difficulty`)}</label>
        <div class="diff-grid">${me.map(e=>{let t=Ft[e];return`<button class="btn-diff btn-diff--${t.tier}" data-diff="${e}"><span class="diff-icon">${t.icon}</span>${pe(e)}</button>`}).join(``)}</div>
      </div>
      <div class="setup-section">
        <label class="setup-label">${v(`setup_grid`)}</label>
        <div class="grid-size-row">${[3,4,5,6].map(e=>`<button class="btn-grid-size" data-size="${e}"><span class="grid-size-label">${e}×${e}</span>${It(e)}</button>`).join(``)}</div>
      </div>
      <button class="btn-start" id="btn-start" disabled>${v(`setup_start`)}</button>
    </div>`,document.getElementById(`btn-back`).onclick=X;let e=null,t=4;document.querySelector(`[data-size="4"]`).classList.add(`selected`),document.querySelectorAll(`.btn-diff`).forEach(t=>{t.onclick=()=>{document.querySelectorAll(`.btn-diff`).forEach(e=>e.classList.remove(`selected`)),t.classList.add(`selected`),e=t.dataset.diff,document.getElementById(`btn-start`).disabled=!1}}),document.querySelectorAll(`.btn-grid-size`).forEach(e=>{e.onclick=()=>{document.querySelectorAll(`.btn-grid-size`).forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`),t=parseInt(e.dataset.size,10)}}),document.getElementById(`btn-start`).onclick=()=>{e&&$(e,t)}}function Rt(){J(),R.innerHTML=`
    <div class="screen setup-screen">
      <div class="screen-header">
        <button class="btn-back" id="btn-back">${v(`back`)}</button>
        <h2>${B(j,v(`menu_multi`))}</h2>
      </div>
      <div class="setup-section">
        <label class="setup-label">${v(`setup_players`)}</label>
        <div class="multi-grid multi-grid--players">${[2,3,4].map(e=>`<button class="btn-player-count" data-count="${e}"><span class="diff-icon">${j}</span>${v(`n_players`,{n:e})}</button>`).join(``)}</div>
      </div>
      <div class="setup-section" id="team-section" style="display:none">
        <label class="setup-label">${v(`setup_mode`)}</label>
        <div class="multi-grid multi-grid--teams">
          <button class="btn-team-mode selected" data-team="false">${v(`setup_solo`)}</button>
          <button class="btn-team-mode" data-team="true">${v(`setup_teams`)}</button>
        </div>
      </div>
      <div class="setup-section">
        <label class="setup-label">${v(`setup_grid`)}</label>
        <div class="multi-grid multi-grid--sizes">${[3,4,5,6].map(e=>`<button class="btn-grid-size" data-size="${e}"><span class="grid-size-label">${e}×${e}</span>${It(e)}</button>`).join(``)}</div>
      </div>
      <button class="btn-start" id="btn-start" disabled>${v(`setup_start`)}</button>
    </div>`,document.getElementById(`btn-back`).onclick=X;let e=0,t=!1,n=4;document.querySelector(`[data-size="4"]`).classList.add(`selected`),document.querySelectorAll(`.btn-player-count`).forEach(t=>{t.onclick=()=>{document.querySelectorAll(`.btn-player-count`).forEach(e=>e.classList.remove(`selected`)),t.classList.add(`selected`),e=parseInt(t.dataset.count,10),document.getElementById(`team-section`).style.display=e===4?`block`:`none`,document.getElementById(`btn-start`).disabled=!1}}),document.querySelectorAll(`.btn-team-mode`).forEach(e=>{e.onclick=()=>{document.querySelectorAll(`.btn-team-mode`).forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`),t=e.dataset.team===`true`}}),document.querySelectorAll(`.btn-grid-size`).forEach(e=>{e.onclick=()=>{document.querySelectorAll(`.btn-grid-size`).forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`),n=parseInt(e.dataset.size,10)}}),document.getElementById(`btn-start`).onclick=()=>{e&&Bt(e,t,n)}}function zt(){J();let e=[{icon:`•••`,title:v(`tut_step1_title`),desc:v(`tut_step1_desc`)},{icon:`⬜`,title:v(`tut_step2_title`),desc:v(`tut_step2_desc`)},{icon:`★`,title:v(`tut_step3_title`),desc:v(`tut_step3_desc`)},{icon:`🔄`,title:v(`tut_step4_title`),desc:v(`tut_step4_desc`)}];R.innerHTML=`
    <div class="screen setup-screen">
      <div class="screen-header">
        <button class="btn-back" id="btn-back">${v(`back`)}</button>
        <h2>${B(it,v(`menu_tutorial`))}</h2>
        <span class="header-end-spacer"></span>
      </div>
      <div class="tut-steps">
        ${e.map((e,t)=>`
      ...
      <div class="tut-board-hint">
        ...
        <p class="tut-hint-text">${v(`tut_hint`)}</p>
      </div>
    </div>`,document.getElementById(`btn-back`).onclick=X}function Q(e,t=!1){if(!t&&!L.unlimitedEnergy&&!Ye()){K(v(`energy_no`));return}let n=xe(e);F={mode:`arcade`,stageId:e,botDifficulty:n.difficulty,controller:new p({gridSize:n.gridSize,players:[{name:v(`you`),color:z[0]},{name:v(`bot`),color:z[1]}]}),botPlayerId:`p2`,botThinking:!1,freeRetry:!1,maxChain:0},Vt()}function $(e,t){F={mode:`vs-bot`,botDifficulty:e,controller:new p({gridSize:t,players:[{name:v(`you`),color:z[0]},{name:v(`bot`),color:z[1]}]}),botPlayerId:`p2`,botThinking:!1,freeRetry:!1},Vt()}function Bt(e,t,n){let r=mt();F={mode:`multi`,teamMode:t,playerCount:e,controller:new p({gridSize:n,players:Array.from({length:e},(e,t)=>({name:r[t],color:z[t]}))}),botThinking:!1,freeRetry:!1},Vt()}function Vt(){if(!F)return;let e=F;J();let t=e.mode===`arcade`?B(M,v(`stage_label`,{id:e.stageId})):e.mode===`vs-bot`?B(A,`${v(`menu_bot`)} · ${pe(e.botDifficulty)}`):B(j,e.teamMode?v(`teams_2v2`):v(`n_players`,{n:e.playerCount}));R.innerHTML=`
    <div class="screen game-screen">
      <div class="game-hud">
        <div class="screen-header">
          <button class="btn-back" id="btn-back">${v(`back`)}</button>
          <h2>${t}</h2>
          ${L.unlimitedEnergy?`<button class="btn-god-corner" id="btn-god-game">👑</button>`:`<span class="header-end-spacer"></span>`}
        </div>
        <div id="scoreboard" class="scoreboard"></div>
        <div id="status" class="status"></div>
      </div>
      <div class="canvas-wrapper"><canvas id="board"></canvas></div>
    </div>`,document.getElementById(`btn-back`).onclick=()=>{F=null,I=null,e.mode===`arcade`?Z():e.mode===`vs-bot`?Lt():Rt()},document.getElementById(`btn-god-game`)?.addEventListener(`click`,()=>Et(e.stageId));let n=document.getElementById(`board`),i=n.getContext(`2d`);function a(){let t=e.controller.getState(),{width:r,height:a}=ie(t.gridSize);n.width=r,n.height=a,ae(i,t,I,e.teamMode??!1),o()}function o(){let t=e.controller.getState(),n=document.getElementById(`scoreboard`),r=document.getElementById(`status`);if(!(!n||!r)){if(e.teamMode&&e.playerCount===4){let e=t.players.filter((e,t)=>t%2==0).reduce((e,t)=>e+t.score,0),r=t.players.filter((e,t)=>t%2==1).reduce((e,t)=>e+t.score,0);n.innerHTML=`<div class="team-chip" style="--pc:${z[0]}">${v(`team_a`)} <strong>${e}</strong></div><div class="team-chip" style="--pc:${z[1]}">${v(`team_b`)} <strong>${r}</strong></div>`}else n.innerHTML=t.players.map(e=>`<div class="player-chip ${e.id===t.currentPlayerId&&t.status===`playing`?`player-chip--active`:``}" style="--pc:${e.color}"><span class="player-dot"></span><span class="player-name">${e.name}</span><span class="player-score">${e.score}</span></div>`).join(``);if(t.status===`finished`)r.textContent=``,s();else if(e.botThinking)r.textContent=v(`game_bot_thinking`),r.style.color=`var(--text-2)`;else{let e=t.players.find(e=>e.id===t.currentPlayerId);r.textContent=v(`game_turn`,{name:e.name}),r.style.color=e.color}}}function s(){let t=e.controller.getState(),n=Math.max(...t.players.map(e=>e.score));if(e.mode===`arcade`&&e.stageId!=null){let n=xe(e.stageId),r=t.players.find(t=>t.id!==e.botPlayerId),i=t.players.find(t=>t.id===e.botPlayerId),a=r.score>i.score,o=r.score===i.score;if(a){let t=(n.gridSize-1)**2,a=1,o=100;if(n.objectiveType===`win`)r.score>=Math.ceil(t*.65)?(a=3,o+=100):r.score>=Math.ceil(t*.5)&&(a=2,o+=50);else if(n.objectiveType===`margin`)r.score-i.score>=n.objectiveValue+2?(a=3,o+=100):r.score-i.score>=n.objectiveValue&&(a=2,o+=50);else if(n.objectiveType===`dominance`)r.score/t>=.75?(a=3,o+=100):r.score/t>=n.objectiveValue/100&&(a=2,o+=50);else if(n.objectiveType===`clean`)i.score===0&&r.score-i.score>=3?(a=3,o+=100):i.score===0&&(a=2,o+=50);else if(n.objectiveType===`chain`){let t=e.maxChain??0;t>=3?(a=3,o+=100):t>=2&&(a=2,o+=50)}Ue(e.stageId,a,r.score*100,o);let s=e.stageId<50?e.stageId+1:null;W(a,o,v(`stage_label`,{id:e.stageId}),s,()=>{s?Q(s):Z()},()=>{F=null,I=null,Z()})}else{let t=()=>{if(!L.unlimitedEnergy&&!Ye()){K(v(`energy_no`));return}F=null,I=null,Q(e.stageId,!0)},n=()=>{F=null,I=null,Z()},r=e.stageId<50?e.stageId+1:null;G(t,n,o,!o&&r!=null?{available:Ce(),onSkip:()=>wt(()=>{we()?(F=null,I=null,Q(r,!0)):K(v(`no_skips_left`))})}:void 0)}}else if(e.mode===`vs-bot`){let r=t.players.find(t=>t.id!==e.botPlayerId),i=t.players.find(t=>t.id===e.botPlayerId);r.score===i.score?G(()=>$(e.botDifficulty,t.gridSize),X,!0):r.score===n?W(1,60,v(`victory`),null,()=>$(e.botDifficulty,t.gridSize),X):G(()=>$(e.botDifficulty,t.gridSize),X)}else{let r=t.players.filter(e=>e.score===n);W(3,80,``,null,()=>Bt(e.playerCount,e.teamMode,t.gridSize),X,r.length===1?`${r[0].name} ${v(`won_suffix`)}`:v(`tie`))}}function c(){return!!e.botPlayerId&&e.controller.getState().currentPlayerId===e.botPlayerId}function l(){e.botDifficulty&&(e.botThinking=!0,o(),setTimeout(()=>{if(!F||F!==e)return;let t=e.controller.getState();t.status===`finished`||!c()||(e.controller.playLine(ve(t,e.botDifficulty)),e.botThinking=!1,a(),c()&&e.controller.getState().status!==`finished`&&l())},ye(e.botDifficulty)))}function u(t){let n=e.controller.getState();if(n.status===`finished`||e.botThinking||c()||t.ownerId!==null)return;let r=e.botPlayerId==null?0:n.players.find(t=>t.id!==e.botPlayerId)?.score??0;e.controller.playLine(t),I=null,a();let i=e.botPlayerId==null?0:e.controller.getState().players.find(t=>t.id!==e.botPlayerId)?.score??0;if(Fe(i>r?[40,20,40]:18),e.mode===`arcade`&&e.botPlayerId!=null){let t=i-r;t>(e.maxChain??0)&&(e.maxChain=t)}c()&&e.controller.getState().status!==`finished`&&l()}n.addEventListener(`mousemove`,t=>{let i=e.controller.getState();if(i.status===`finished`||e.botThinking||c())return;let{x:o,y:s}=H(n,t.clientX,t.clientY),l=oe(i,o,s),u=l?.ownerId===null?l:null;(I?r(I):null)!==(u?r(u):null)&&(I=u,a()),n.style.cursor=I?`pointer`:`default`}),n.addEventListener(`mouseleave`,()=>{I=null,a(),n.style.cursor=`default`}),n.addEventListener(`click`,t=>{let{x:r,y:i}=H(n,t.clientX,t.clientY),a=oe(e.controller.getState(),r,i);a&&u(a)}),n.addEventListener(`touchend`,t=>{t.preventDefault();let r=t.changedTouches[0];if(!r)return;let{x:i,y:a}=H(n,r.clientX,r.clientY),o=oe(e.controller.getState(),i,a);o&&u(o)},{passive:!1}),a(),c()&&l()}var Ht=document.createElement(`style`);Ht.textContent=`
/* ── Variáveis de tema ─────────────────────────────────────────── */
...
`,document.head.appendChild(Ht),document.addEventListener(`click`,e=>{let t=e.target;t.closest(`button`)&&!t.closest(`canvas`)&&Fe(8)},{passive:!0}),X();